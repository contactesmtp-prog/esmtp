...
//   return (
//     <footer className="mt-auto bg-[#0C2E53] text-white border-t border-white/10">
//       <div className="container pl-4 pr-0 py-16 grid grid-cols-1 md:grid-cols-[1fr_1fr_1fr] gap-12">
//         {/* Column 1: Logo + Social */}
//         <div className="flex flex-col gap-6 md:ml-4">
//           <Link href="/" className="w-fit">
//             <Logo className="h-24 w-auto ml-2" /> {/* Bigger logo + shifted right */}
//           </Link>

//           <p className="text-sm opacity-80 max-w-xs ml-2">
...
//                   className="hover:text-[#D78B22] transition"
...
//             <div key={i}>
//               {group.title && (
//                 <h4 className="text-sm font-semibold mb-3 text-white">{group.title}</h4>
//               )}
...
//         {/* Column 3: Google Map (shifted right) */}
//         <div className="w-full h-64 rounded-lg overflow-hidden shadow-lg ml-auto max-w-md ">
//           <iframe
//             src={
//               mapEmbedUrl ||
...
//       {/* Copyright */}
//       <div className="text-center text-sm py-4 border-t border-white/10 opacity-70">
//         © 2025 - Tous droits réservés - ESMTP
//       </div>
//     </footer>
//   )
// }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <div className="relative group">
              ...
              <div className="absolute -inset-1 bg-gradient-to-r from-[#D78B22]/20 to-transparent rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-xl"></div>
            </div>
          </div>
        </div>
      </div>
