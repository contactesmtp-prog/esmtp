...
import { VideosBlock } from '@/blocks/VideosBlock/config'
import { LastEvent } from '@/blocks/LastEvents/config'
import { ThemeOverviewBlock } from '@/blocks/ThemeListBlock/config'
import { RentalOverviewBlock } from '@/blocks/RentItemBlock/config'
import { Partners } from '@/blocks/Partners/config'
import { GroupedItems } from '@/blocks/InfrastructureBlock/config'
import { TextImageGroupBlock } from '@/blocks/WhyESMTPblock/config'
